...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sobel

#else
#  define SWIG_init    init_sobel

#endif
#define SWIG_name    "_sobel"
...
SWIGINTERN PyObject *_wrap_SobelOperator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "SobelOperator" "', argument " "1"" of type '" "std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = SobelOperator(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "SobelOperator", _wrap_SobelOperator, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
